    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="getwayApp.app1Invoice.home.createOrEditLabel">
              <Translate contentKey="getwayApp.app1Invoice.home.createOrEditLabel">Create or edit a Invoice</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
